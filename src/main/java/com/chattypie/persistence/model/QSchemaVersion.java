...
public class QSchemaVersion extends com.querydsl.sql.RelationalPathBase<SchemaVersion> {
    ...
    private static final long serialVersionUID = 1732885111;
    ...
    public final com.querydsl.sql.PrimaryKey<SchemaVersion> primary = createPrimaryKey(installedRank);

    public QSchemaVersion(String variable) {
        super(SchemaVersion.class, forVariable(variable), "null", "schema_version");
        addMetadata();
    }
    ...
    public QSchemaVersion(String variable, String schema) {
        super(SchemaVersion.class, forVariable(variable), schema, "schema_version");
        addMetadata();
    }
    ...
    public QSchemaVersion(PathMetadata metadata) {
        super(SchemaVersion.class, metadata, "null", "schema_version");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(success, ColumnMetadata.named("success").withIndex(10).ofType(Types.BIT).notNull());
