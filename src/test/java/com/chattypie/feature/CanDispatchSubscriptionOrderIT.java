...
public class CanDispatchSubscriptionOrderIT {
	...
	public void subscriptionOrderCreatesAccountAndRoomOnChattyPieAndSendsEmail() throws Exception {
		...
		assertThat(EntityUtils.toString(response.getEntity())).isEqualTo("{\"success\":true,\"message\":\"Event with eventToken=order has been accepted by the connector. It will be processed soon.\"}");
